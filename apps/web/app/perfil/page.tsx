...
export default function ProfilePage() {
  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_top,#1e3a5f,transparent_45%),#0f172a] px-4 py-8 text-white sm:px-8">
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3"><ProfileStats heroClass={heroClass} totalXp={profile.total_xp || 0} {...progression} /><CharacterCustomizer heroClass={heroClass} outfit={outfit} onClassChange={setHeroClass} onOutfitChange={setOutfit} /><LuckboxOpener heroClass={heroClass} available={progression.luckboxesEarned} /></div>
